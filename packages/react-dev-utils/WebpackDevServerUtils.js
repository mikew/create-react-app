...
function createCompiler(
  ...
  compiler.hooks.done.tap('done', async _stats => {
    if (isInteractive) {
      clearConsole();
    }
    ...
    if (useTypeScript) {
      console.log(
        chalk.yellow(
          'Files successfully emitted, waiting for TypeScript results...'
        )
      );
      ...
      _stats.compilation.errors.push(...messages.errors);
      _stats.compilation.warnings.push(...messages.warnings);
      ...
      // Show warnings if no errors were found.
        ...
        devSocket.isWaitingTypeScript(false);
        devSocket.ok();
      }
    }
